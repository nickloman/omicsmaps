...
function Cluster(markerClusterer) {
  ...
  this.addMarker = function (marker) {
    ...
    count += marker.marker.machine_count;
  ...
  this.redraw_ = function (isForce) {
    ...
    if (zoom_ >= mz || this.getTotalMarkers() === 1) {
      ...
      if (clusterMarker_ === null) {
        clusterMarker_ = new ClusterMarker_(center_, this.getTotalMarkers(), markerClusterer_.getStyles_(), markerClusterer_.getGridSize_(), this.getTotalMarkerCount());
  ...
  this.getTotalMarkerCount = function () {
    return count;
  };

  this.getClusterMarker = function () {
    return clusterMarker_;
  };
}
 ...
 */
function ClusterMarker_(latlng, count, styles, padding, display_count) {
  var index = 0;
  var dv = display_count;
  while (dv !== 0) {
...
ClusterMarker_.prototype.copy = function () {
  return new ClusterMarker_(this.latlng_, this.count_, this.text_, this.styles_, this.padding_, this.text_);
};
